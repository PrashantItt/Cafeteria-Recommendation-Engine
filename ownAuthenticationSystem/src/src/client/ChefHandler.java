...
public class ChefHandler implements RoleHandler {
    ...
    private void initializeMenuActions() {
        ...
        menuActions.put(4, this::generateMonthlyReport);
        menuActions.put(5, this::viewDiscardMenu);
        menuActions.put(6, this::getAllFeedbackByFoodName);
    }
    ...
    private void finalizeMenuForNextDay() {
        String menuIds = promptForString("Enter the MenuId for the next day (comma separated Id): ");
    ...
    private void removeFoodItem() {
        ...
        String foodItemName = promptForString("Enter the name of the food item to be removed from the menu: ");
    ...
    private void getDetailedFeedback() {
        ...
        String foodItemName = promptForString("Enter the name of the food item for which you want detailed feedback: ");
        sendRequest(foodItemName);
        receiveAndPrintResponse("End of Response");
    }

    private void getAllFeedbackByFoodName() {
        String foodItemName = promptForString("Enter the name of the food item to view all feedback: ");
